...
class LocatieService:
    ...
    def get_locatie(self, asset_uuid: str) -> LocatieKenmerk:
    ...
    def update_locatie(self, bron_asset_uuid: str, doel_asset_uuid: str = None, wkt_geometry: str = None):
        """
        Update locatie based on a WKT-string or via an existing relation
        Call this function with parameter doel_asset_uuid to set the locatie via an existing relationship.
