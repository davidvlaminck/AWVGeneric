...
fake_assets = [asset_1, asset_2, asset_3, asset_4, asset_5, asset_6, asset_7, asset_8, asset_9,
               asset_21, asset_22, asset_23, asset_24, asset_25, asset_26, asset_inactief,
               relatie_10, relatie_11, relatie_12, relatie_13, relatie_14, relatie_15,
               relatie_31, relatie_32, relatie_33, relatie_34, relatie_35]


@pytest.fixture
def fake_emson_client() -> EMSONClient:
    ...
    with patch.object(EMSONClient, '__init__', __init__):
        ...
        emson_client.requester = Mock(spec=AbstractRequester)
        with (patch.object(EMSONClient, 'get_assets_by_filter', get_assets_by_filter),
            patch.object(EMSONClient, 'get_assetrelaties_by_filter', get_assetrelaties_by_filter)):
            yield emson_client

@pytest.fixture
def fake_eminfra_client() -> EMInfraClient:
    ...
    with patch.object(EMInfraClient, '__init__', __init__):
        ...
        with (patch.object(EMInfraClient, 'get_objects_from_oslo_search_endpoint',
                           get_objects_from_oslo_search_endpoint)):
