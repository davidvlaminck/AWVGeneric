...
if __name__ == '__main__':
    ...
    for index in range(len(df_assets)):
        kabelnettoegang_naam = df_assets.iloc[index].kabelnettoegang_naam
        ...
        df_assets.iloc[index].kabelnettoegang_uuid = asset_uuid
        ...
        asset_HoortBij.assetId.identificator = f'HoortBij_relatie_{index}'
        asset_HoortBij.bronAssetId.identificator = f'{df_assets.iloc[index].kabelnettoegang_uuid}-b25kZXJkZWVsI0thYmVsbmV0VG9lZ2FuZw'
        asset_HoortBij.bron.typeURI = 'https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#KabelnetToegang'
        asset_HoortBij.doelAssetId.identificator = f'{df_assets.iloc[index].teletransmissieverbinding_uuid}-bGdjOmluc3RhbGxhdGllI1RU'
