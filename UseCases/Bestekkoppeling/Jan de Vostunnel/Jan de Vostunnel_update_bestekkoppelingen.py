...
if __name__ == '__main__':
    ...
    logging.info('Tunnelorganisatie Vlaanderen: \tBestekkoppelingen toevoegen voor assets van de Jan de Vostunnel')
    ...
    filepath_input = Path.home() / 'Downloads' / 'Bestekken_JDV_tunnel' / 'export_JDV.TUNNEL-bestekken_2.xlsx'
    usecols = ['naampad', 'uuid', 'toezichter', 'toezichtsgroep', 'bestek1_naam', 'bestek1_datum', 'bestek2_naam', 'bestek2_datum', 'bestek3_naam', 'bestek3_datum', 'bestek4_naam', 'bestek4_datum']
    ...
    for idx, df_asset in df_assets.iterrows():
        ...
        for i in range(1,5):
            ...
            if pd.isna(bestek_naam):
                continue
            bestek_datum = datetime.strptime(df_asset[f"bestek{i}_datum"], "%d/%m/%Y")
