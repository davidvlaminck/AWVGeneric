    ...
    return QueryDTO(
        ...
        , selection=SelectionDTO(
            expressions=[ExpressionDTO(
                terms=[TermDTO(property='toezichter', operator=OperatorEnum.EQ, value=toezichter_uuid)])]))
...
if __name__ == '__main__':
    ...
    columns = ["provincie", "gemeente", "beheerobject", "naampad", "naam", "uri", "uuid", "toestand", "actief",
               "toezichter", "geometry", "LGC/OTL"]
    data_list = []
